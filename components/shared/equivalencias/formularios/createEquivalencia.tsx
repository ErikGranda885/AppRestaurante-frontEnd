  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(err.message || "Error al registrar equivalencia");
      }

      toast.success("Equivalencia registrada correctamente");
      ...
      toast.error(err.message || "Error al registrar equivalencia");
    }
  };
